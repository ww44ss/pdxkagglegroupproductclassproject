...
## GET TRAINING DATA
        ...
        train_data$target[train_data$target=="Class_2"|train_data$target=="Class_3"|train_data$target=="Class_4"]<-"Class_345"
        train_data$target<-as.character(train_data$target)
...
##MAKE SUBMISSION
        ...
        ## write csv
        write.csv(submission, paste0(directory,"May14x",".csv"), row.names=F, quote=F)
