...
Classification tree:
tree(formula = target ~ . - target - id, data = train_data)
Variables actually used in tree construction:
[1] "feat_11" "feat_60" "feat_34" "feat_14" "feat_15" "feat_90" "feat_86"
[8] "feat_36"
Number of terminal nodes:  9 
Residual mean deviance:  2.489 = 37310 / 14990 
Misclassification error rate: 0.4256 = 6384 / 15000 
```
...
```
[1] Class_2 Class_5 Class_8 Class_2 Class_2 Class_6
